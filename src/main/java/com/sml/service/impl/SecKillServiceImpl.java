...
import com.sml.service.RedisLock;
import com.sml.service.SecKillService;
...
public class SecKillServiceImpl implements SecKillService
{
    ...
    {
        return "中秋活动，月饼特价，限量份" + products.get(productId) + " 还剩：" + stock.get(productId) + " 份" + " 该商品成功下单用户数目：" + orders.size() + " 人";
    }
